    ...
    return (
        <motion.div className='rounded-[32px] relative group transition-all' onMouseEnter={handleHover}
            ...
            <div className='absolute bottom-12 md:px-14 px-8 w-full'>
                <h3
                    className={`md:text-[2.5rem] group-hover:hidden mt-10 text-[1.5rem] md:leading-[3.1rem] leading-[1.875rem] -tracking-[1.5px] text-white group-hover:text-white/60  ${TxtColour && "text-center text-[#FFA4A5] w-full"}`}>
                    <div
                        className=""
                    ...
                    ></div></h3>
                <motion.h3 variants={TextAnimation} initial="offScreen" whileInView="onScreen" transition={{ duration: 0.1 }}
                    className={`md:text-[2.5rem] hidden group-hover:block mt-10 text-[1.5rem] md:leading-[3.1rem]  leading-[1.875rem] -tracking-[1.5px] text-white group-hover:text-white/60  ${TxtColour && "text-center group-hover:text-[#FFA4A5] text-[#FFA4A5]"}`}>
                    <div
                        className=""
                        dangerouslySetInnerHTML={{
                            __html: title,
                ...
                <motion.p variants={TextAnimation} initial="offScreen" whileInView="onScreen" transition={{ duration: 0.1 }}
                    className={`md:text-[1.25rem] text-[0.9rem] transition-all md:leading-[1.6rem] leading-[1.2rem] -trackin
                    g-[1.5px] font-medium mt-5 md:hidden group-hover:block ${TxtColour ? TxtColour : 'text-white'}`}>
                    {content}</motion.p>
            </div>
        </motion.div>
    )

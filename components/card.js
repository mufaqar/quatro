...
export default function Card({ title, content, image_path }) {
    return (
        <div className='rounded-[32px] relative group transition-all'>
            <Image src={image_path} alt="Image Missing" className='object-cover w-full h-full rounded-[32px] group-hover:blur-sm' />
            <div className='absolute bottom-12 md:px-14 px-8'>
                <h3 className='md:text-[2.5rem] text-[1.5rem] md:leading-[3.1rem] leading-[1.875rem] font-bold -tracking-[1.5px] text-white mt-10'>
                    {title}</h3>

    ...
    return (
        <motion.div className='rounded-[32px] relative group transition-all' onMouseEnter={handleHover}
            ...
            <div className='absolute bottom-12 md:px-14 px-8'>
                <h3
                    className='md:text-[2.5rem] group-hover:hidden mt-10 text-[1.5rem] md:leading-[3.1rem] leading-[1.875rem] font-bold -tracking-[1.5px] text-white group-hover:text-white/70 '>
                    <div
                        className=""
                ...
                <motion.p variants={TextAnimation} initial="offScreen" whileInView="onScreen" transition={{ duration: 0.1 }}
                    className='md:text-[2.5rem] hidden group-hover:block mt-10 text-[1.5rem] md:leading-[3.1rem] leading-[1.875rem] font-bold -tracking-[1.5px] text-white group-hover:text-white/70 '>
                    <div
                        className=""
                        dangerouslySetInnerHTML={{
                            __html: title,
